public class TestConsigne {
	...
	public static void main(String[] args) {
		...
		System.out.println("test22 : consigne de gare avec 0 casier");
		try{
			consigne = new Consigne(0);
			System.out.println("test22 constructeur 0 consigne KO : il fallait lancer une exception de type IllegalArgumentException");
			System.exit(0);
		...
		// Le nombre de casiers doit etre > 0
		System.out.println("test23 : consigne de gare avec -1 casiers");
		try{
			consigne = new Consigne(-1);
			System.out.println("test23 constructeur -1 consigne KO : il fallait lancer une exception de type IllegalArgumentException");
			System.exit(0);
		...
		// Le nombre de casiers doit etre > 0
		System.out.println("test24 : consigne de gare avec 0 casier");
		try{
			consigne = new Consigne(0);
			System.out.println("test24 constructeur 0 consigne KO : il fallait lancer une exception de type IllegalArgumentException");
			System.exit(0);
