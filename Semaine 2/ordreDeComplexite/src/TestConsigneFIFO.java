...
public class TestConsigneFIFO{
	...
	public static void main(String[] args) {
		...
		System.out.println("Les tests se font avec une ConsigneFIFO comportant 3 casiers");
		System.out.println();
		...
		// D'abord le 1, puis le 0, puis le 2
		// la file : tete 1 0 2 queue
		
		System.out.println("test6 : liberation casier 1 - mdp");
		try{
			assertEquals("test6 ko", true,consigne.libererCasier(1, "mdp"));
		}catch (Exception e){
		...
		System.out.println("test8 : liberation casier 2 - mdp");
		try{
			assertEquals("test8 ko", true,consigne.libererCasier(2, "mdp"));
		}catch (Exception e){
		...
		System.out.println();
		System.out.println("test9 : liberation du casier 0 - mdp");
		try{
			assertEquals("on ne peut liberer un casier qui est libre : test9 ko", false,consigne.libererCasier(0, "mdp"));
		}catch (Exception e){
		...
		System.out.println("test22 : ConsigneFIFO de gare avec 0 casier");
		try{
			consigne = new ConsigneFIFO(0);
			System.out.println("test22 constructeur 0 ConsigneFIFO KO : il fallait lancer une exception de type IllegalArgumentException");
			System.exit(0);
		...
		// Le nombre de casiers doit etre > 0
		System.out.println("test23 : ConsigneFIFO de gare avec -1 casiers");
		try{
			consigne = new ConsigneFIFO(-1);
			System.out.println("test23 constructeur -1 ConsigneFIFO KO : il fallait lancer une exception de type IllegalArgumentException");
			System.exit(0);
		...
		// Le nombre de casiers doit etre > 0
		System.out.println("test24 : ConsigneFIFO de gare avec 0 casier");
		try{
			consigne = new ConsigneFIFO(0);
			System.out.println("test24 constructeur 0 ConsigneFIFO KO : il fallait lancer une exception de type IllegalArgumentException");
			System.exit(0);
